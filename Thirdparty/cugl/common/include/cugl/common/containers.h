...
#include <cugl/common/containers/device_array.h>
#include <cugl/common/containers/texture_bridge.h>
...
typedef DeviceArray<unsigned int>     ElementArray;
...
typedef DeviceArray2D<float>          ColorImage32f;
